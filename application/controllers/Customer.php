...
class Customer extends CI_Controller
{
	...
	public function create()
	{
		$data = [
			...
			"kode_pelanggan" => $this->Customer_model->makeCustomerCode()
		];
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$customerData = [
				"kode_pelanggan" => $this->input->post("customer_code"),
				"nama_pelanggan" => $this->input->post("customer_name"),
				"email_pelanggan" => $this->input->post("customer_email"),
				"no_pelanggan" => $this->input->post("customer_phone"),
				"alamat_pelanggan" => $this->input->post("customer_address")
			];
