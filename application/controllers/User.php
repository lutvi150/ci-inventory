...
class User extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('user_email', 'E-mail', 'required|valid_email|is_unique[users.email_user]');
        $this->form_validation->set_rules('user_phone', 'Nomor HP', 'required|is_unique[users.no_user]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $userData = [
                ...
                "no_user" => $this->input->post("user_phone"),
                "alamat_user" => $this->input->post("user_address"),
                "foto_user" => $userAvatar,
                "password_user" => password_hash($this->input->post("user_password"), PASSWORD_DEFAULT),
                "hak_akses" => $this->input->post("user_role"),
            ];
