...
class Report extends CI_Controller
{
    ...
    public function barangKeluar(Type $var = null)
    {
        $data['barangKeluar'] = $this->model->getDataBarangKeluar();
        // $this->load->view("reports/v_report_barang_keluar", $data);
        ...
        // $this->dompdf->load_html($html);
        // $this->dompdf->render();
        // $this->dompdf->stream("REKAP_DATA_BARANG_KELUAR.pdf", array('Attachment' => 0));
    ...
    // barang masuk
    public function barangMasuk(Type $var = null)
    {
