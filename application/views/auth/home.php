...
<head>
    <title>Cv.Setya Jaya &mdash; Home</title>
    <!-- header -->
...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="site-blocks-cover" style="background-image: url(<?= base_url("asset/images/bg_2.jpg") ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row row-custom align-items-center">
                    <div class="col-md-10">
                        <h1 class="mb-2 text-black w-75"><span class="font-weight-bold">CV. Setia Jaya</span> Perusahaan Jasa Pembangunan</h1>
            ...
            <div class="container">
                <div class="row justify-content-start text-left mb-5">
                    <div class="col-md-9" data-aos="fade">
                        <h2 class="font-weight-bold text-black">Riwayat Proyek</h2>
                    </div>
                            ...
                            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                                ...
                                <div class="mb-4 mb-md-0 mr-5">
                                    <div class="job-post-item-header d-flex align-items-center">
                                        <h2 class="mr-3 text-black h4"><?= $proyek["nama_proyek"] ?></h2>
                                        <div class="badge-wrap">
                                            <span class=""> <?php if ($proyek["progres"] == 'Proses') : ?>
                                                    <div class="bg-warning text-white badge py-2 px-4">Proses</div>
                                                <?php else : ?>
                                                    <div class="bg-primary text-white badge py-2 px-4">Selesai</div>
                                                <?php endif; ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="job-post-item-body d-block d-md-flex">
                                        <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> <a href="#"><?= $proyek["nama_pelanggan"] ?></a></div>
                                        <div><span class="fl-bigmug-line-big104"></span> <span><?= $proyek["instansi_proyek"] ?></span></div>
                                    </div>
                                </div>
        ...
        <div class="site-section block-4 bg-light">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-md-6" data-aos="fade">
                        <h2 class="text-black">Mitra Kerjasama</h2>
                    </div>
                </div>
                            ...
                            <div class="block-38 text-center bg-white p-4">
                                <div class="block-38-img">
                                    <div class="block-38-header">
                                        <img src="<?= base_url("assets/uploads/users/" . $user["foto_user"]) ?>" alt="Image placeholder">

                                        <h3 class="block-38-heading"><?= $user["nama_user"] ?></h3>
                                        <p class="block-38-subheading"><?= $user["email_user"] ?></p>
                                    </div>
