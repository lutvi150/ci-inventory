								...
								<div class="card-body">
									<div class="row">
										<div class="col-8 mx-auto">
											<form action="<?= base_url("item/update/" . $item["id_barang"]) ?>" method="post" enctype="multipart/form-data">
												<div class="form-group">
													<div class="form-group">
														<label for="item_code">Kode Barang</label>
														<input type="text" class="form-control" name="item_code" id="item_code" placeholder="Kode Barang" value="<?= $item["kode_barang"] ?>" readonly>
													</div>
													...
													<select name="id_unit" id="id_unit" class="form-control select2">
														...
														<?php foreach ($units as $unit) : ?>
															...
															<?php if ($unit["id_unit"] == $item["id_unit"]) : ?>
																<option value="<?= $unit["id_satuan"] ?>" selected><?= $unit["nama_satuan"] ?></option>
															<?php else : ?>
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('item_name') ? 'is-invalid' : ''; ?>" name="item_name" id="item_name" placeholder="Nama Barang" value="<?= $item["nama_barang"] ?>">
												...
												<div class="form-group">
													...
													<div class="row">
														<div class="col-sm-4">
															<img src="<?= base_url("assets/uploads/items/" . $item["foto_barang"]) ?>" width="100%">
														</div>
												...
												<div class="form-group">
													...
													<input type="number" class="form-control <?= form_error('item_stock') ? 'is-invalid' : ''; ?>" name="item_stock" id="item_stock" placeholder="Stok Barang" value="<?= $item["stok_barang"] ?>">
												</div>
												<?= form_error('item_stock', '<div class="invalid-feedback font-weight-bold pl-1">', '</div>') ?>
												<div class="form-group">
													<label for="item_price">Harga Barang</label>
													<input type="number" class="form-control <?= form_error('item_price') ? 'is-invalid' : ''; ?>" name="item_price" id="item_price" placeholder="Harga Barang" value="<?= $item["harga_barang"] ?>">
												...
												<div class="form-group">
													...
													<textarea name="item_description" id="item_description" rows="3" class="form-control"><?= $item["diskripsi_barang"] ?></textarea>
												</div>
												<hr>
												<div class="form-action">
													<button type="submit" class="btn btn-primary btn-lg">Simpan Data</button>
													<a href="<?= base_url("item/index") ?>" class="btn btn-info btn-lg">Kembali</a>
