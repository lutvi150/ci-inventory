												...
												<?php foreach ($customers as $customer) : ?>
													<tr>
														...
														<td>
															...
															<a href="<?= base_url("customer/update/" . $customer["id_pelanggan"]) ?>" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-pencil-alt"></i></a>
															<a href="<?= base_url("customer/delete/" . $customer["id_pelanggan"]) ?>" class="btn btn-danger btn-circle btn-sm btn-delete"><i class="fas fa-trash"></i></a>
														</td>
													</tr>
												<?php endforeach; ?>
											</tbody>
