										...
										<div class="col-8 mx-auto">
											<form action="<?= base_url("supplier/create") ?>" method="post">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('supplier_name') ? 'is-invalid' : ''; ?>" name="supplier_name" id="supplier_name" placeholder="Nama Supplier">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('supplier_email') ? 'is-invalid' : ''; ?>" name="supplier_email" id="supplier_email" placeholder="Email Supplier">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('supplier_phone') ? 'is-invalid' : ''; ?>" name="supplier_phone" id="supplier_phone" placeholder="Phone Supplier">
												...
												<div class="form-action">
													...
													<!-- <button type="reset" href="<?= base_url("supplier") ?>" class="btn btn-warning btn-lg">Reset Form</button> -->
												</div>
											</form>
										</div>
									</div>
